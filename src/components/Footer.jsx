...
const Footer = () => {
  return (
    <footer className='footer'>
      <ScrollToTop className='scrollToTop' smooth top="4000" width="20" height="20" color='#0069e0' style={{ right: 0, bottom: 30 }} />
      <div className='contenedor'>
        ...
        <div className='footer_conten_copyright'>
          ...
          <div className='footer_social'>
            <a href="https://www.behance.net/javiergraphico" title="Behance/Javiergraphico" target='_blank'>
              <svg className='footer_icon' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"  viewBox="0 0 16 16">
